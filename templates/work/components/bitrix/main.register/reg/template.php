...
<h4><?echo GetMessage("MAIN_REGISTER_AUTH")?></h4>
...
<?
		...
		default:
			...
			?>
			<div class="form-group">
			<input size="30" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" class="form-control" placeholder="<?=GetMessage("REGISTER_FIELD_".$FIELD)?>"/>
 			</div>
			<?
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td><input type="submit" class="btn nikki-btn mt-15" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
